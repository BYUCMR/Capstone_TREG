function [  ] = Plot_Node_Boxes_Spec( x_vec_temp, T2T_Qual, d_up, d_down, d_length, d_width, trans )
...
%         T2T_Angle_2(i,j)=acos(Tube1_Vec*Tube2_Vec'/(norm(Tube1_Vec)*norm(Tube2_Vec)));
    ...
    color=[0 0 0]
    patch('faces',faces,'vertices',vertices,'facecolor',color,'facealpha',trans, 'edgecolor','k','linewidth', 1);
    hold on
    end
