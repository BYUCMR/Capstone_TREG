function [ x_opt, Ldot ] = Controled_Motion_Nodes_Dist( x, Edges_All, Edge_All_Tube, Loop_Con, L2th, Order, A, b, L_norm, Cost_Index, L, Local )
...
N_robots=6; %The number of kinematic nodes, or actual robots. (Hardcoded for now)
