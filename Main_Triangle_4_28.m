...
%     Node_Control=0;  %For now Hardcoded (picks the node, or the center of mass)
    ...
    %Get the data from the Microcontroller
...
L_meas=Get_Lengths_E(Edges_All,x_adj); %Get these results from actual measurements instead
...
d_diag=L_meas(end); %The diagonal distance
