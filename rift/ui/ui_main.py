...
"color: rgb(0, 0, 0);")
        ...
        self.L221.addWidget(self.eq_all, 0, 0, 1, 1)

        self.mb_11 = QPushButton(self.motor_tab)
        self.mb_11.setObjectName(u"mb_11")

        self.L221.addWidget(self.mb_11, 11, 0, 1, 1)
        ...
        self.L221.addWidget(self.ms_10, 10, 1, 1, 1)
        ...
        self.L221.addWidget(self.ms_2, 2, 1, 1, 1)
        ...
        self.L221.addWidget(self.ms_4, 4, 1, 1, 1)

        self.mb_6 = QPushButton(self.motor_tab)
        self.mb_6.setObjectName(u"mb_6")

        self.L221.addWidget(self.mb_6, 6, 0, 1, 1)
        ...
        self.L221.addWidget(self.ms_9, 9, 1, 1, 1)

        self.mb_1 = QPushButton(self.motor_tab)
        self.mb_1.setObjectName(u"mb_1")

        self.L221.addWidget(self.mb_1, 1, 0, 1, 1)
        ...
        self.L221.addWidget(self.ms_3, 3, 1, 1, 1)
        ...
        self.L221.addWidget(self.ms_8, 8, 1, 1, 1)

        self.mb_10 = QPushButton(self.motor_tab)
        self.mb_10.setObjectName(u"mb_10")

        self.L221.addWidget(self.mb_10, 10, 0, 1, 1)
        ...
        self.L221.addWidget(self.ms_11, 11, 1, 1, 1)
        ...
        self.L221.addWidget(self.ms_5, 5, 1, 1, 1)
        ...
        self.L221.addWidget(self.ms_1, 1, 1, 1, 1)
