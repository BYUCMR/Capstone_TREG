...
class Ui_Control(object):
    def setupUi(self, Control):
        ...
        self.L12 = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.L1.addItem(self.L12)

        self.L13 = QGridLayout()
        self.L13.setObjectName(u"L13")
        self.pushButton_10 = QPushButton(self.verticalLayoutWidget_2)
        self.pushButton_10.setObjectName(u"pushButton_10")

        self.L13.addWidget(self.pushButton_10, 1, 0, 1, 1)
